        ...
        <div className="flex items-center justify-between h-20">
          <div className="flex items-center">
            <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
              ...
              <span className="self-center text-2xl font-semibold whitespace-nowrap text-indigo-600">Raytni</span>
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-6">
            <nav className="space-x-4">
              ...
              <Button variant="ghost" onClick={onCreatePost} className="text-gray-700 hover:text-indigo-600"><PlusCircle className="mr-2 h-5 w-5"/>{t('nav.createPost')}</Button>
