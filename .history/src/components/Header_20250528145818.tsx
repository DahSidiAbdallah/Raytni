...
const Header = ({ onCreatePost, onViewBrowse, onViewHome, onViewPolice }: HeaderProps) => {
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-6">
            <nav className="space-x-4">
              ...
              <Button variant="ghost" onClick={onViewPolice} className="text-gray-700 hover:text-indigo-600"><Shield className="mr-2 h-5 w-5"/>{t('nav.police')}</Button>
            </nav>
          </div>
            ...
            <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
              ...
              <SheetContent side="left" className="w-64 p-6">
                <nav className="flex flex-col space-y-4">
                  ...
                  <SheetClose asChild>
                    <Button variant="ghost" onClick={onCreatePost} className="justify-start text-lg hover:text-indigo-600"><PlusCircle className="mr-3 h-6 w-6"/>{t('nav.createPost')}</Button>
                  </SheetClose>
                  <SheetClose asChild>
                    <Button variant="ghost" onClick={onViewPolice} className="justify-start text-lg hover:text-indigo-600"><Shield className="mr-3 h-6 w-6"/>{t('nav.police')}</Button>
                  </SheetClose>
                  <hr className="my-4"/>
                  <SheetClose asChild>
