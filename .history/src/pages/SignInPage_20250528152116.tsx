      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          <form onSubmit={handleSignIn} className="space-y-6">
            <div>
              <Label htmlFor="phone" className="block text-sm font-medium text-gray-700 text-start">{t('page.signin.phoneLabel')}</Label>
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <Input
                  ...
                  className={`appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm ${inputPaddingClasses}`}
                  placeholder="+222 XX XX XX XX" // Placeholder might be kept as is for format example
                  dir={language === 'ar' ? 'rtl' : 'ltr'} // Explicitly set dir for placeholder
                />
              </div>
            </div>

            <div>
              <Label htmlFor="password" className="block text-sm font-medium text-gray-700 text-start">{t('page.signin.passwordLabel')}</Label>
              <div className="mt-1 relative rounded-md shadow-sm">
                <div className={iconContainerClasses}>
